    ...
    public void build() {
	  ...
	  class BoutonEnvoyer implements ActionListener{
	    public void actionPerformed(ActionEvent arg0) {
	    	...
	    	else { lbl_erreur.setText("Veuillez renseigner le fichier � envoyer et l'adresse"); }
	    }
	  }
	  ...
	  class BoutonRecevoir implements ActionListener{
	    public void actionPerformed(ActionEvent e) {
	    	...
	    	else { lbl_erreur.setText("Veuillez renseigner le fichier � recevoir et l'adresse"); }
	    }
	  }      
}
